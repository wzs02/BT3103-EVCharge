      ...
      <div class=Map>
        ...
        <GMapMap :center="center" :zoom="11.80" map-type-id="roadmap"
          ...
          <GMapMarker :key="index" v-for="(m, index) in Available_Markers.value" :position="m.position"
            ...
            :draggable=false>
            <MapPageOffcanvas :drawer="showWindow(m.id)" :stationID="m.station_id" :stationName="m.id"
              :imgExtension="m.imgName" :chargerType="parseChargerType(Object.values({ ...m.chargerDetails.type }))"
