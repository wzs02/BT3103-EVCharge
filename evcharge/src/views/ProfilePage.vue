                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="mb-4">
                        ...
                        <input id="myInput" class="form-control" type="text" placeholder="How do we address you?"
                          v-model="username">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-6">
                      <div class="mb-4">
                        ...
                        <input class="form-control" type="text" placeholder="Your EV's License Plate Number"
                          v-model="plate">
                      </div>
                    </div>
